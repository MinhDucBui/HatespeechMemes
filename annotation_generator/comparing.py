...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotation1', '-a1', type=str,
                        default='/Users/duc/Desktop/Projects/Ongoing/MultiModalMemes/dataset/annotation/hatespeech/de_duc.xlsx')
    parser.add_argument('--annotation2', '-a2', type=str,
                        default='/Users/duc/Desktop/Projects/Ongoing/MultiModalMemes/dataset/annotation/hatespeech/de_timm.xlsx')
    parser.add_argument('--comparison', '-c', type=str,
                        default='/Users/duc/Desktop/Projects/Ongoing/MultiModalMemes/dataset/annotation/hatespeech/de_comparison.xlsx')
    ...
    diff = df_annotation1["Hate Speech (=1) or Non-Hate Speech (=0)"].astype(int) == df_annotation2["Hate Speech (=1) or Non-Hate Speech (=0)"]
