...
if __name__ == '__main__':
    ...
    parser.add_argument('--final_dataset', '-f', type=str,
                        default='/Users/duc/Desktop/Projects/Ongoing/MultiModalMemes/dataset/final_new/multimodal.xlsx')
    ...
    for language in LANGUAGES:
        ...
        # Load the text file into a DataFrame
        df_annotation = pd.read_excel(final_dataset)
        df_annotation = df_annotation.drop_duplicates()
        instances_processing = list(df_annotation["instance_id"])
