...
def set_prompts(language):
    return PROMPTS_MULTI[language], PROMPT_CAPTION_MULTI[language], PROMPT_PREFIX_MULTI[language], PROMPT_POSTFIX_MULTI[language], PROMPT_IMAGE_PREFIX_MULTI[language]
