...
if __name__ == '__main__':
    ...
    merged_df = merged_df[~merged_df["Image ID"].isin(SKIP_EXAMPLES.keys())]
    ...
    print("Enough Instances")
    for instance in enough:
        print(instance)

    print("\nNot Enough Instances")
    for instance in not_enough:
        print(instance)

    print(len(enough))
    print(len(not_enough))
