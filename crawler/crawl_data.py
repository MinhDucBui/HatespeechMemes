...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', '-s', type=str, default='memegenerator.net',
                        help='data source')
    parser.add_argument('--save-dir', '-d', type=str,
    ...
    # crawling arguments
    parser.add_argument('--poolsize', '-p', type=int, default=1,
                        help='size of the multiprocessing Pool')
    parser.add_argument('--num-templates', '-t', type=int, default=1,
                        help='number of templates to crawl')
    parser.add_argument('--num-captions', '-c', type=int, default=3000,
